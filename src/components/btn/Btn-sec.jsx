...
export default function Btn_sec() {
  return (
    <div className="relative w-fit">
      <button
        className="flex group flex-row-reverse text-[20px] gap-2 md:gap-3 items-center rounded-[10px] py-[14px] border-[3px] 
        px-[15px] md:py-[20px] md:px-[40px] 2xl:py-[12px] 2xl:px-[20px] md:text-[30px] font-medium ease-in-out text-primary
      bg-green duration-300 hover:bg-opacity-[0.6] hover:text-primary "
      >
        <span className="animate-pulse -rotate-45 group-hover:rotate-0 w-[20px] h-[25px] md:w-[30px] md:h-[35px] ">
          <svg
            width="100%"
            height="100%"
            viewBox="0 0 10 8"
