  ...
  return (
    <div className='relative w-fit' >
      <div className="seeProject flex cursor-pointer">
        <Link to='project' className='flex  flex-row-reverse group text-[16px] relative  text-[white]  gap-2 md:gap-3 items-center rounded-[10px] py-[12px]  border-2
      px-[15px] lg:py-[10px] lg:px-[20px] 2xl:py-[12px] 2xl:px-[20px] md:text-[20px] font-medium overflow-hidden hover:ease-in-out
      hover:border-0  hover:bg-green 
     duration-500  bg-transparent   hover:text-primary '><span className='animate-pulse -rotate-45 group-hover:rotate-0 '><svg width="20" height="25" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// <button className='flex  flex-row-reverse group text-[16px] lg:text-lg relative  text-[white]  gap-2 md:gap-3 items-center rounded-[10px] py-[12px]  border-2
//       px-[15px] lg:py-[10px] lg:px-[20px] 2xl:py-[20px] 2xl:px-[30px] md:text-[25px] font-medium overflow-hidden z-[10] hover:ease-in-out
