...
<div className="hero-container flex  h-[80vh] sm:h-[75vh] lg:h-[80vh]  max-w-[85%]   md:pl-[20px] 2xl:pl-[150px]  border sm:py-20  lg:py-0 ">
...
<h2 className='mb-[5px] font-medium text-[18px] text-[white]
            lg:text-[25px]  3xl:text-[30px]
               '>Hi, I'm</h2>
    <h1 className='name text-secondary text-xl sm:text-3xl lg:text-2xl leading:lg  mb-8 lg:mb-8        
                  '>Ajimati Taiye,</h1>
  ...
  <p className="body text-secondary lg:overflow-auto text-sm opacity-40 text-left lg:text-md 2xl:text-2xl md:max-w-[600px] 2xl:max-w-[60%]   mb-10 xl:mb-14 2xl:mb-24
