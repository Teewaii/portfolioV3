...
export default function Hello() {
  ...
  <section id='hero' className="hero bg-primary min-h-[100vh] flex flex-col items-center justify-between pt-24 lg:pt-0 overflow-hidden snap-start ">
...
<h2 className='mb-[5px] font-medium text-[18px] text-[white]
  ...
  <motion.h1  initial={{ x: 10,opacity:0.3 }}
      whileInView={{ x: 0,opacity:1}}
      transition={{ duration: 1 }} className='header font-700  text-[white] text-left mb-4 leading-10 sm:text-5xl 2xl:text-7xl xl:max-w-[75%] 2xl:max-w-[70%] lg:leading-[60px] 2xl:leading-[90px] tracking-normal ' >I <span className='text-green'>Design</span>  & <span className='text-green'>Build</span>  Web Based Software Solutions!</motion.h1>
  <motion.p initial={{ x: -10,opacity:0.8 }}
      ...
      transition={{ duration: 1 }}
       className="body text-secondary text-sm opacity-40 text-left lg:text-md 2xl:text-lg md:max-w-[600px] 2xl:max-w-[60%]   mb-10 xl:mb-14 2xl:mb-24
               ">I’m a  software engineer with focus in frontend development and I occassionly design products & sevices with great experience and accessibility. </motion.p>
