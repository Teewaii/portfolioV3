...
export default function Nav({ toggle, toggleMenu, setToggle }) {
  ...
  return (
    <nav
      className={
        shadow
          ? " bg-primary sticky left-0 right-0 shadow-xl z-[2000] top-0 NavShadow  "
          : " bg-primary  sticky left-0 right-0  z-[2000]  top-0 NavShadow"
      }
    >
      <div className="navContainer container flex items-center  justify-between py-[20px] md:py-[30px] 3xl:py-[45px] ">
        ...
        <div className="icon space-x-8 flex items-center z-[90] md:hidden ">
          <div
            className="toggles md:hidden relative z-[290] "
            onClick={toggleMenu}
          >
            {toggle ? (
              <img
                className="md:hidden w-[28px] cursor-pointer"
                src={hamburger}
                alt="hamburger"
              />
            ) : (
              <img
                className="md:hidden w-[25px] cursor-pointe"
                src={close}
                alt="close-menu"
              />
            )}
