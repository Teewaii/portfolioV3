...
export default function SideNav({ toggle, toggleMenu, setToggle }) {
  ...
  return (
    <nav
      ...
      className={
        toggle
          ? "hidden  lg:block fixed top-0 bottom-0 bg-navbg text-[white] max-w-[150px] hover:max-w-[230px] ease-in-out duration-300 pl-8 h-[100vh] py-[5rem] space-y-16 md:space-y-20 2xl:space-y-28  group z-[90000] "
          : "fixed top-0 bottom-0 bg-navbg text-[white] w-fit pl-20 h-[100vh] py-[2rem] lg:py-[5rem] space-y-16 md:space-y-20 2xl:space-y-28 group z-50 "
      }
    >
