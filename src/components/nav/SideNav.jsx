...
export default function SideNav({ toggle, toggleMenu, setToggle }) {
  ...
  return (
    <nav
      ...
      // ? "hidden lg:block fixed top-0 bottom-0 bg-navbg text-[white] max-w-[150px] hover:max-w-[230px] pl-8 h-[100vh] py-[5rem] space-y-16 md:space-y-20 2xl:space-y-28  group z-[90000] "
