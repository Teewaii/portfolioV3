...
export default function Footer() {
  return (
    ...
    lg:h-[60vh]
    '>
      <div className="footer-wrapper flex flex-col items-center lg:pl-[120px] 2xl:lg:pl-[0px] 
      ">
        ...
        <div className="copywright opacity-50 border-t w-[100%] border-secondary border-opacity-30 pt-7 mt-[180px]">
