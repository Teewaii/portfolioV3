       ...
       ">
         ...
         ">
            {projects.map((item, index) =>
              <h1 key={item.id} className={project === index ? 'text-[white] relative min-w-fit bg-secondary bg-opacity-[0.05] text-sm  font-normal py-[15px] px-[20px] after:absolute after:bg-secondary  after:top-[-1%]  after:bottom-[94%] after:left-0 after:right-0 md:after:top-0  md:after:bottom-[0] md:after:left-[98%] md:after:right-[1px]  after:rounded-[5%] cursor-pointer after:delay-100 ease-in-out duration-300' : 'text-[white] relative text-sm md:text-sm font-normal py-[15px] px-[20px] min-w-fit cursor-pointer hover:after:top-0  hover:after:bottom-[0] hover:after:left-[98%] hover:after:right-[1px] hover:bg-secondary hover:bg-opacity-[0.1]'}
