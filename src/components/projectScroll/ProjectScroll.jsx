    ...
    >
      <div className="bucket flex flex-col items-center  md:pt-[2rem] container">
       ...
       ">
         ...
         flex md:flex-col gap-4 md:border-b-[0px]  overflow-auto relative after:absolute after:top-0 after:bottom-0 md:after:right-[2px]  md:after:w-[1.5px] md:after:bg-secondary md:after:opacity-[0.05]
         ">
