...
export default function Experience() {
  ...
  return (
    <section id='experience' className=" flex items-center justify-center   experience min-h-[100vh] lg:[90vh] bg-primary   ">
      <div className="bucket  flex flex-col items-center pt-[8rem]  md:py-[10rem] container lg:pl-[120px] 2xl:lg:pl-[0px] 
     ">
      ...
      ">
        ...
        flex   border-opacity-[0.1] border-secondary overflow-auto overflow-y-hidden lg:pt-[0rem] lg:pb-[10px]
        '     >
            {
              work.map((work, index) => {
                return (

                  <div className={exp === index ? "after:rounded-[5px] px-[30px] py-[20px] relative bg-secondary bg-opacity-[.05] rounded-t-lg after:absolute after:bg-secondary after:left-0 after:right-0 after:bottom-[4%] after:top-[90%] text-[1rem] lg:text-[1.2rem] cursor-pointer min-w-fit lg:mr-4" : "tab px-[30px] py-[20px]  cursor-pointer text-[1rem] lg:text-[1.2rem] min-w-fit lg:mr-8 "}
                  ...
                  <div className={exp === index ? "content text-left lg:ml-[30px] pt-[30px]" : "tab hidden"}
                    ...
                    <ul className='space-y-2 mt-3'>
                      ...
                      {work.desc.map((duties, index) => (
                        ...
                        <li key={index} className='tools text-secondary flex items-start  gap-2 space-y-4 '><span className='pt-2 '><svg width="18" height="12" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
