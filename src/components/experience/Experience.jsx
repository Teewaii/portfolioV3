     ...
     "
      >
        <div className="section-title gap-y-4 lg:gap-y-0 flex flex-col items-start  lg:items-center">
          <h1 className="text-white lg:mb-[1rem]  mb-0 text-[1.5rem] lg:text-[2rem] relative before:absolute before:left-0 before:right-0 before:bg-green before:h-1 before:bottom-0 before:z-[-1] z-40 ">
            Places I have worked
          </h1>
          <p className="text-white text-[1rem]  text-left lg:text-center  opacity-80 max-w-[700px]  mb-[2rem]">
            Over the years I have worked in different sectors ranging from the
            IT industry, advertising and publishing and I have delivered great
            products and services while working as a web developer and graphic
            designer during this periods.{" "}
          </p>
        </div>

        <motion.div
          className="experience-wrapper border-[3px] rounded-xl px-6  border-opacity-[0.1] border-secondary  flex flex-col
      ...
      "
        ...
        >
          {/* Companys container */}
          <div
            className="tabs-head  text-[1.4rem] text-white py-[0.6rem] 
            ...
            {work.map((work, index) => {
              return (
                <div
                  className={
                    exp === index
                      ? "after:rounded-[5px] px-[20px] py-[14px] relative bg-secondary  ease-in-out duration-300 bg-opacity-[.13] rounded-t-md after:absolute after:bg-secondary after:left-0 after:right-0 after:bottom-[4%] after:top-[90%] text-sm lg:text-md cursor-pointer min-w-fit lg:mr-4 "
                      : "  ProjectTab px-[20px] py-[14px]  cursor-pointer text-sm lg:text-md min-w-fit lg:mr-8 "
                  }
            ...
            {work.map((work, index) => {
              return (
                ...
                >
                  ...
                  <span className="text-secondary opacity-40 pb-[30px] text-sm">
                    {work.about}
                  </span>
                  <ul className="space-y-2 mt-3">
                    ...
                    {work.desc &&
                      work.desc.map((duties, index) => (
                        <li
                          key={index}
                          className="tools text-secondary flex items-start  gap-2 space-y-4 text-sm  "
                        >
                          <span className="pt-2 ">
                            <svg
                              width="18"
