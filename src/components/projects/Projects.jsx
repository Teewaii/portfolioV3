              ...
              ">
                  ...
                  lg:mb-[20px] lg:text-xl  '>{item.head}</h1>
                    ...
                    <div className="icons flex items-center gap-[30px] mt-[20px]">
                      <span className='group cursor-pointer' ><a href={item.live} target='none'><svg width="28" height="28" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span className=' cursor-pointer '><a href={item.git} target='none'><svg width="20" height="20" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
